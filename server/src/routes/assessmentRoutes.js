...
router.post('/submit', authenticateToken, async (req, res) => {
  try {
    ...
    // Auto-generate initial learning roadmap for top career
...
// 3. GET /api/assessment/results/:userId
router.get('/results/:userId', authenticateToken, async (req, res) => {
  try {
    ...
    if (!result) {
      // Fallback default demonstration assessment result
